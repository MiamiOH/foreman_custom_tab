...
class HostsControllerTest < ActionController::TestCase 
  ...
  describe 'When hosts#show' do
    ...
    test 'AJAX request hosts/:id/custom_tab displays custom host data' do
      skip("xhr route missing: ActionController::UrlGenerationError: No route matches {:action=>'/hosts/host6/custom_tab', :controller=>'hosts'}")  
      ...
      get custom_tab_host_path(host), xhr: true 
